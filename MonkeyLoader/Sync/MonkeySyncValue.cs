...
namespace MonkeyLoader.Sync
{
    ...
    public interface ILinkedMonkeySyncValue<out TLink, out TSyncObject, T> : INotifyValueChanged<T>,
            IReadOnlyMonkeySyncValue<TLink, TSyncObject, T>, IWriteOnlyMonkeySyncValue<TLink, TSyncObject, T>
        where TSyncObject : ILinkedMonkeySyncObject<TLink>
    {
        /// <inheritdoc cref="ILinkedMonkeySyncValue{TLink, TSyncObject}.Value"/>
        public new T Value { get; set; }
    }

    /// <summary>
    /// Defines the interface for readonly <see cref="ILinkedMonkeySyncValue{TLink, TSyncObject}"/>s.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Defines the interface for writeonly <see cref="ILinkedMonkeySyncValue{TLink, TSyncObject}"/>s.
    /// </summary>
    /// <remarks>
        ...
        where TSyncValue : MonkeySyncValue<TLink, TSyncObject, TSyncValue, T>
    {
        ...
        object? ILinkedMonkeySyncValue<TLink, TSyncObject>.Value
        {
            get => Value;
            set => Value = (T)value!;
        }
